...
return(
    <View>
    <ImageBackground source={bg_img} style={styles.backgroundImage}></ImageBackground>    
    ...
    <View>
        ...
        <Text style={[styles.cardText, {marginTop: 20, marginLeft: 50}]}>Closest to Earth-{item.close_approach_data[0].close_approach_date_full}</Text>
         <Text style={[styles.cardText, {marginTop: 20, marginLeft: 50}]}>Minimum diameter-{item.estimated_diameter.kilometers.estimated_diameter_minimum}</Text>
         <Text style={[styles.cardText, {marginTop: 20, marginLeft: 50}]}>Maximum diameter-{item.estimated_diameter.kilometers.estimated_diameter_maximum}</Text>
    </View>
    </View>
)
}
